...
Examples:
  ...
  'plugins.importexport.users.import.encryptionMismatch' => 'Cannot use passwords hashed with {$importHash}; OMP is configured to use {$ompHash}. If you continue, you will need to reset the imported users\' passwords.',
  'plugins.importexport.users.unknownPress' => 'An unknown press path "{$pressPath}" was specified.',
