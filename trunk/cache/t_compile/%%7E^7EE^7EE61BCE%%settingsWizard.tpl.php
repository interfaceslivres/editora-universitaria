...
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'controllers/wizard/settings/settingsWizard.tpl', 17, false),array('function', 'url', 'controllers/wizard/settings/settingsWizard.tpl', 25, false),array('modifier', 'escape', 'controllers/wizard/settings/settingsWizard.tpl', 17, false),)), $this); ?>
...
',
				finishButtonText: '<?php echo ((is_array($_tmp=$this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.finish"), $this))) ? $this->_run_mod_handler('escape', true, $_tmp, 'javascript') : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp, 'javascript'));?>
'
			});
	});
</script>
<div id="settingsWizard">
	<ul>
		<li><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('router' => @ROUTE_COMPONENT,'component' => "tab.settings.PressSettingsTabHandler",'op' => 'showTab','tab' => 'masthead','wizardMode' => true), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "manager.setup.masthead"), $this);?>
</a></li>
		<li><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('router' => @ROUTE_COMPONENT,'component' => "tab.settings.PressSettingsTabHandler",'op' => 'showTab','tab' => 'contact','wizardMode' => true), $this);?>
