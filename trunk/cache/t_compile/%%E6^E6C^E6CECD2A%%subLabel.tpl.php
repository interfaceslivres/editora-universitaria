<?php /* Smarty version 2.6.26, created on 2013-07-25 19:02:23
         compiled from form/subLabel.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'concat', 'form/subLabel.tpl', 12, false),array('modifier', 'escape', 'form/subLabel.tpl', 19, false),array('function', 'translate', 'form/subLabel.tpl', 20, false),)), $this); ?>
...
<?php endif; ?>
<label class="sub_label<?php if ($this->_tpl_vars['FBV_error']): ?> error<?php endif; ?>" <?php if (! $this->_tpl_vars['FBV_suppressId']): ?> for="<?php echo ((is_array($_tmp=$this->_tpl_vars['forElement'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
"<?php endif; ?>>
