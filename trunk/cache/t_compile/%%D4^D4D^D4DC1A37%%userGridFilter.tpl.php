<?php /* Smarty version 2.6.26, created on 2013-07-25 19:13:44
         compiled from controllers/grid/settings/user/userGridFilter.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'controllers/grid/settings/user/userGridFilter.tpl', 17, false),array('function', 'fbvElement', 'controllers/grid/settings/user/userGridFilter.tpl', 20, false),array('function', 'fbvFormButtons', 'controllers/grid/settings/user/userGridFilter.tpl', 28, false),array('block', 'fbvFormArea', 'controllers/grid/settings/user/userGridFilter.tpl', 18, false),array('block', 'fbvFormSection', 'controllers/grid/settings/user/userGridFilter.tpl', 19, false),)), $this); ?>
...
<form class="pkp_form" id="userSearchForm" action="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('router' => @ROUTE_COMPONENT,'component' => "grid.settings.user.UserGridHandler",'op' => 'fetchGrid'), $this);?>
" method="post">
	<?php $this->_tag_stack[] = array('fbvFormArea', array('id' => 'userSearchFormArea')); $_block_repeat=true;$this->_plugins['block']['fbvFormArea'][0][0]->smartyFBVFormArea($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
		<?php $this->_tag_stack[] = array('fbvFormSection', array('title' => "common.search",'required' => 'true','for' => 'search')); $_block_repeat=true;$this->_plugins['block']['fbvFormSection'][0][0]->smartyFBVFormSection($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
