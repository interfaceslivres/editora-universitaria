...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'controllers/tab/catalogEntry/form/publicationMetadataFormFields.tpl', 14, false),array('modifier', 'concat', 'controllers/tab/catalogEntry/form/publicationMetadataFormFields.tpl', 24, false),array('modifier', 'assign', 'controllers/tab/catalogEntry/form/publicationMetadataFormFields.tpl', 43, false),array('function', 'url', 'controllers/tab/catalogEntry/form/publicationMetadataFormFields.tpl', 23, false),array('function', 'translate', 'controllers/tab/catalogEntry/form/publicationMetadataFormFields.tpl', 33, false),array('function', 'fbvElement', 'controllers/tab/catalogEntry/form/publicationMetadataFormFields.tpl', 37, false),array('function', 'load_url_in_div', 'controllers/tab/catalogEntry/form/publicationMetadataFormFields.tpl', 44, false),array('function', 'fbvFormButtons', 'controllers/tab/catalogEntry/form/publicationMetadataFormFields.tpl', 108, false),array('block', 'fbvFormArea', 'controllers/tab/catalogEntry/form/publicationMetadataFormFields.tpl', 35, false),array('block', 'fbvFormSection', 'controllers/tab/catalogEntry/form/publicationMetadataFormFields.tpl', 36, false),)), $this); ?>
<?php ob_start(); ?>publicationMetadataEntryForm-<?php echo $this->_tpl_vars['publicationFormatId']; ?>
...
<script type="text/javascript">
	$(function() {
		...
		$('#<?php echo ((is_array($_tmp=$this->_tpl_vars['publicationFormId'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'javascript') : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp, 'javascript')); ?>
').pkpHandler(
...
<form class="pkp_form" id="<?php echo ((is_array($_tmp=$this->_tpl_vars['publicationFormId'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
...
" />
	<input type="hidden" name="tabPos" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['formParams']['tabPos'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
" />
...
" />
	...
	<?php $this->_tag_stack[] = array('fbvFormArea', array('id' => 'catalogInclusion')); $_block_repeat=true;$this->_plugins['block']['fbvFormArea'][0][0]->smartyFBVFormArea($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
		<?php $this->_tag_stack[] = array('fbvFormSection', array('list' => 'true')); $_block_repeat=true;$this->_plugins['block']['fbvFormSection'][0][0]->smartyFBVFormSection($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
			<?php echo $this->_plugins['function']['fbvElement'][0][0]->smartyFBVElement(array('type' => 'checkbox','id' => 'isApproved','checked' => $this->_tpl_vars['isApproved'],'label' => "monograph.publicationFormat.isApproved"), $this);?>

		<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo $this->_plugins['block']['fbvFormSection'][0][0]->smartyFBVFormSection($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
	<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo $this->_plugins['block']['fbvFormArea'][0][0]->smartyFBVFormArea($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>

		<?php if ($this->_tpl_vars['paymentConfigured']): ?>
		<?php echo ((is_array($_tmp=$this->_plugins['function']['url'][0][0]->smartyUrl(array('router' => @ROUTE_COMPONENT,'component' => "grid.files.proof.ApprovedProofFilesGridHandler",'op' => 'fetchGrid','monographId' => $this->_tpl_vars['monographId'],'publicationFormatId' => $this->_tpl_vars['publicationFormatId'],'escape' => false), $this))) ? $this->_run_mod_handler('assign', true, $_tmp, 'approvedProofGridUrl') : $this->_plugins['modifier']['assign'][0][0]->smartyAssign($_tmp, 'approvedProofGridUrl'));?>

		<?php echo $this->_plugins['function']['load_url_in_div'][0][0]->smartyLoadUrlInDiv(array('id' => "approvedProofGrid-".($this->_tpl_vars['publicationFormatId']),'url' => $this->_tpl_vars['approvedProofGridUrl']), $this);?>
	...
	<?php $this->_tag_stack[] = array('fbvFormArea', array('id' => 'productIdentifier')); $_block_repeat=true;$this->_plugins['block']['fbvFormArea'][0][0]->smartyFBVFormArea($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
		<?php $this->_tag_stack[] = array('fbvFormSection', array()); $_block_repeat=true;$this->_plugins['block']['fbvFormSection'][0][0]->smartyFBVFormSection($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
			...
			<?php $this->assign('divId', ((is_array($_tmp=((is_array($_tmp='identificationCodeGridContainer')) ? $this->_run_mod_handler('concat', true, $_tmp, $this->_tpl_vars['publicationFormatId']) : $this->_plugins['modifier']['concat'][0][0]->smartyConcat($_tmp, $this->_tpl_vars['publicationFormatId'])))) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp))); ?>
			<?php echo ((is_array($_tmp=$this->_plugins['function']['url'][0][0]->smartyUrl(array('router' => @ROUTE_COMPONENT,'component' => "grid.catalogEntry.IdentificationCodeGridHandler",'op' => 'fetchGrid','monographId' => $this->_tpl_vars['monographId'],'publicationFormatId' => $this->_tpl_vars['publicationFormatId'],'escape' => false), $this))) ? $this->_run_mod_handler('assign', true, $_tmp, 'identGridUrl') : $this->_plugins['modifier']['assign'][0][0]->smartyAssign($_tmp, 'identGridUrl'));?>
	...
	<?php $this->_tag_stack[] = array('fbvFormArea', array('id' => 'salesRights')); $_block_repeat=true;$this->_plugins['block']['fbvFormArea'][0][0]->smartyFBVFormArea($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
		<?php $this->_tag_stack[] = array('fbvFormSection', array()); $_block_repeat=true;$this->_plugins['block']['fbvFormSection'][0][0]->smartyFBVFormSection($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
			...
			<?php $this->assign('divId', ((is_array($_tmp=((is_array($_tmp='salesRightsGridContainer')) ? $this->_run_mod_handler('concat', true, $_tmp, $this->_tpl_vars['publicationFormatId']) : $this->_plugins['modifier']['concat'][0][0]->smartyConcat($_tmp, $this->_tpl_vars['publicationFormatId'])))) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp))); ?>
			<?php echo ((is_array($_tmp=$this->_plugins['function']['url'][0][0]->smartyUrl(array('router' => @ROUTE_COMPONENT,'component' => "grid.catalogEntry.SalesRightsGridHandler",'op' => 'fetchGrid','monographId' => $this->_tpl_vars['monographId'],'publicationFormatId' => $this->_tpl_vars['publicationFormatId'],'escape' => false), $this))) ? $this->_run_mod_handler('assign', true, $_tmp, 'salesGridUrl') : $this->_plugins['modifier']['assign'][0][0]->smartyAssign($_tmp, 'salesGridUrl'));?>
	...
	<?php $this->_tag_stack[] = array('fbvFormArea', array('id' => 'marketRegions')); $_block_repeat=true;$this->_plugins['block']['fbvFormArea'][0][0]->smartyFBVFormArea($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
		<?php $this->_tag_stack[] = array('fbvFormSection', array()); $_block_repeat=true;$this->_plugins['block']['fbvFormSection'][0][0]->smartyFBVFormSection($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
			<!-- Market regions -->
			<?php $this->assign('divId', ((is_array($_tmp=((is_array($_tmp='marketsGridContainer')) ? $this->_run_mod_handler('concat', true, $_tmp, $this->_tpl_vars['publicationFormatId']) : $this->_plugins['modifier']['concat'][0][0]->smartyConcat($_tmp, $this->_tpl_vars['publicationFormatId'])))) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp))); ?>
			<?php echo ((is_array($_tmp=$this->_plugins['function']['url'][0][0]->smartyUrl(array('router' => @ROUTE_COMPONENT,'component' => "grid.catalogEntry.MarketsGridHandler",'op' => 'fetchGrid','monographId' => $this->_tpl_vars['monographId'],'publicationFormatId' => $this->_tpl_vars['publicationFormatId'],'escape' => false), $this))) ? $this->_run_mod_handler('assign', true, $_tmp, 'marketsGridUrl') : $this->_plugins['modifier']['assign'][0][0]->smartyAssign($_tmp, 'marketsGridUrl'));?>
	...
	<?php $this->_tag_stack[] = array('fbvFormArea', array('id' => 'publicationDates')); $_block_repeat=true;$this->_plugins['block']['fbvFormArea'][0][0]->smartyFBVFormArea($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
		<?php $this->_tag_stack[] = array('fbvFormSection', array()); $_block_repeat=true;$this->_plugins['block']['fbvFormSection'][0][0]->smartyFBVFormSection($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
			...
			<?php $this->assign('divId', ((is_array($_tmp=((is_array($_tmp='publicationDateGridContainer')) ? $this->_run_mod_handler('concat', true, $_tmp, $this->_tpl_vars['publicationFormatId']) : $this->_plugins['modifier']['concat'][0][0]->smartyConcat($_tmp, $this->_tpl_vars['publicationFormatId'])))) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp))); ?>
			<?php echo ((is_array($_tmp=$this->_plugins['function']['url'][0][0]->smartyUrl(array('router' => @ROUTE_COMPONENT,'component' => "grid.catalogEntry.PublicationDateGridHandler",'op' => 'fetchGrid','monographId' => $this->_tpl_vars['monographId'],'publicationFormatId' => $this->_tpl_vars['publicationFormatId'],'escape' => false), $this))) ? $this->_run_mod_handler('assign', true, $_tmp, 'dateGridUrl') : $this->_plugins['modifier']['assign'][0][0]->smartyAssign($_tmp, 'dateGridUrl'));?>
