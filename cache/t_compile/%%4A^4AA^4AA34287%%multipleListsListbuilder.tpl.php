...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'concat', 'controllers/listbuilder/multipleListsListbuilder.tpl', 10, false),array('modifier', 'uniqid', 'controllers/listbuilder/multipleListsListbuilder.tpl', 11, false),array('modifier', 'escape', 'controllers/listbuilder/multipleListsListbuilder.tpl', 20, false),array('modifier', 'translate', 'controllers/listbuilder/multipleListsListbuilder.tpl', 49, false),)), $this); ?>
...
<script type="text/javascript">
	$(function() {
		$('#<?php echo ((is_array($_tmp=$this->_tpl_vars['gridId'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
').pkpHandler(
 ...
 ?>
				...
				<?php if ($this->_tpl_vars['list']->getTitle()): ?>
					<div class="pkp_helpers_align_left pkp_helpers_full">
						<span class="h4 no_border pkp_helpers_align_left"><?php echo ((is_array($_tmp=$this->_tpl_vars['list']->getTitle())) ? $this->_run_mod_handler('translate', true, $_tmp) : AppLocale::translate($_tmp)); ?>
</span>
					</div>
				<?php endif; ?>
