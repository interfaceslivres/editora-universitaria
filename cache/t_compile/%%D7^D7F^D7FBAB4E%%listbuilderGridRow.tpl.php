...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'concat', 'controllers/listbuilder/listbuilderGridRow.tpl', 10, false),array('modifier', 'uniqid', 'controllers/listbuilder/listbuilderGridRow.tpl', 12, false),array('modifier', 'escape', 'controllers/listbuilder/listbuilderGridRow.tpl', 14, false),)), $this); ?>
...
?>
		<?php if (($this->_foreach['listbuilderCells']['iteration'] <= 1)): ?>
			<td class="first_column">
				<?php if ($this->_tpl_vars['row']->getId()): ?>
					<input type="hidden" name="rowId" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['row']->getId())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
" />
				<?php endif; ?>
...
unset($_smarty_tpl_vars);
 ?>
		...
		<?php else: ?>
			<td class="gridCell"><?php echo $this->_tpl_vars['cell']; ?>
</td>
		<?php endif; ?>
	<?php endforeach; endif; unset($_from); ?>
</tr>