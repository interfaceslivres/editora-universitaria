...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'concat', 'controllers/grid/gridRow.tpl', 10, false),array('modifier', 'escape', 'controllers/grid/gridRow.tpl', 12, false),array('function', 'translate', 'controllers/grid/gridRow.tpl', 35, false),)), $this); ?>
...
"<?php endif; ?>
			<?php if ($this->_tpl_vars['column']->hasFlag('firstColumn')): ?> class="first_column<?php if (! $this->_tpl_vars['row']->hasActions() && ! $this->_tpl_vars['row']->getNoActionMessage()): ?> no_actions<?php endif; ?>"<?php endif; ?>
			<?php if (( $this->_tpl_vars['row']->hasActions() || $this->_tpl_vars['row']->getNoActionMessage() ) && $this->_tpl_vars['column']->hasFlag('firstColumn')): ?>
					>
					<div class="row_container">
						<div class="row_actions">
							<?php if ($this->_tpl_vars['row']->getActions(@GRID_ACTION_POSITION_DEFAULT) || $this->_tpl_vars['row']->getNoActionMessage()): ?>
...
unset($_smarty_tpl_vars);
 ?>
				...
				<?php endforeach; endif; unset($_from); ?>
			<?php else: ?>
				<?php echo $this->_tpl_vars['row']->getNoActionMessage(); ?>
