...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'uniqid', 'submission/form/categories.tpl', 11, false),array('modifier', 'escape', 'submission/form/categories.tpl', 11, false),array('modifier', 'assign', 'submission/form/categories.tpl', 13, false),array('function', 'url', 'submission/form/categories.tpl', 13, false),array('function', 'load_url_in_div', 'submission/form/categories.tpl', 14, false),array('block', 'fbvFormSection', 'submission/form/categories.tpl', 18, false),)), $this); ?>
<?php if ($this->_tpl_vars['categoriesExist']): ?>
	<?php if (! $this->_tpl_vars['readOnly']): ?>
		<?php $this->assign('monographCategoriesContainer', ((is_array($_tmp=((is_array($_tmp="monographCategoriesContainer-")) ? $this->_run_mod_handler('uniqid', true, $_tmp) : uniqid($_tmp)))) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp))); ?>
		<div id=<?php echo $this->_tpl_vars['monographCategoriesContainer']; ?>
>
			<?php echo ((is_array($_tmp=$this->_plugins['function']['url'][0][0]->smartyUrl(array('router' => @ROUTE_COMPONENT,'component' => "submission.CategoriesListbuilderHandler",'op' => 'fetch','monographId' => $this->_tpl_vars['monographId'],'readOnly' => $this->_tpl_vars['readOnly'],'escape' => false), $this))) ? $this->_run_mod_handler('assign', true, $_tmp, 'monographCategoriesUrl') : $this->_plugins['modifier']['assign'][0][0]->smartyAssign($_tmp, 'monographCategoriesUrl'));?>
