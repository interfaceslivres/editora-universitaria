...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'form/select.tpl', 13, false),array('function', 'html_options_translate', 'form/select.tpl', 15, false),array('function', 'html_options', 'form/select.tpl', 15, false),)), $this); ?>
...
"<?php endif; ?><?php if ($this->_tpl_vars['FBV_disabled']): ?> disabled="disabled"<?php endif; ?>>
	<?php if ($this->_tpl_vars['FBV_defaultValue'] !== null): ?>
		<option value="<?php echo ((is_array($_tmp=$this->_tpl_vars['FBV_defaultValue'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
