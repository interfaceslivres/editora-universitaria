...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'concat', 'form/textarea.tpl', 10, false),array('modifier', 'escape', 'form/textarea.tpl', 10, false),array('modifier', 'strip_unsafe_html', 'form/textarea.tpl', 55, false),)), $this); ?>
...
?><?php if ($this->_tpl_vars['formLocale'] != $this->_tpl_vars['thisFormLocale']): ?>
					<?php echo '<textarea id="'; ?><?php echo ((is_array($_tmp=$this->_tpl_vars['FBV_id'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?><?php echo '-'; ?><?php echo ((is_array($_tmp=$this->_tpl_vars['thisFormLocale'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?><?php echo ''; ?><?php echo $this->_tpl_vars['uniqId']; ?><?php echo '" '; ?><?php echo $this->_tpl_vars['FBV_textAreaParams']; ?><?php echo 'placeholder="'; ?><?php echo ((is_array($_tmp=$this->_tpl_vars['thisFormLocaleName'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?><?php echo '"class="locale_'; ?><?php echo ((is_array($_tmp=$this->_tpl_vars['thisFormLocale'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?><?php echo ' '; ?><?php echo $this->_tpl_vars['FBV_class']; ?><?php echo ' '; ?><?php echo $this->_tpl_vars['FBV_height']; ?><?php echo ''; ?><?php if ($this->_tpl_vars['FBV_rich'] && ! $this->_tpl_vars['FBV_disabled']): ?><?php echo ' richContent'; ?><?php endif; ?><?php echo '"'; ?><?php if ($this->_tpl_vars['FBV_disabled']): ?><?php echo ' disabled="disabled"'; ?><?php endif; ?><?php echo ''; ?><?php if ($this->_tpl_vars['FBV_readonly']): ?><?php echo ' readonly="readonly"'; ?><?php endif; ?><?php echo 'name="'; ?><?php echo ((is_array($_tmp=$this->_tpl_vars['FBV_name'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?><?php echo '['; ?><?php echo ((is_array($_tmp=$this->_tpl_vars['thisFormLocale'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?><?php echo ']">'; ?><?php echo ((is_array($_tmp=$this->_tpl_vars['FBV_value'][$this->_tpl_vars['thisFormLocale']])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?><?php echo '</textarea>'; ?>
...
<?php else: ?>
		...
		<?php if ($this->_tpl_vars['FBV_multilingual']): ?><?php echo ((is_array($_tmp=$this->_tpl_vars['FBV_value'][$this->_tpl_vars['formLocale']])) ? $this->_run_mod_handler('strip_unsafe_html', true, $_tmp) : String::stripUnsafeHtml($_tmp)); ?>
<?php else: ?><?php echo ((is_array($_tmp=$this->_tpl_vars['FBV_value'])) ? $this->_run_mod_handler('strip_unsafe_html', true, $_tmp) : String::stripUnsafeHtml($_tmp)); ?>
<?php endif; ?>
	<?php else: ?>
...
<?php endif; ?><?php if ($this->_tpl_vars['FBV_rich'] && ! $this->_tpl_vars['FBV_disabled']): ?> richContent<?php endif; ?>"
