<?php /* Smarty version 2.6.26, created on 2013-07-25 19:03:04
         compiled from controllers/listbuilder/listbuilderGridCell.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'concat', 'controllers/listbuilder/listbuilderGridCell.tpl', 10, false),array('modifier', 'escape', 'controllers/listbuilder/listbuilderGridCell.tpl', 14, false),array('modifier', 'uniqid', 'controllers/listbuilder/listbuilderGridCell.tpl', 38, false),array('function', 'translate', 'controllers/listbuilder/listbuilderGridCell.tpl', 48, false),)), $this); ?>
	...
	<?php else: ?>
		<div class="gridCellDisplay">
			<?php if ($this->_tpl_vars['column']->getFlag('sourceType') === @LISTBUILDER_SOURCE_TYPE_SELECT): ?>
								<input type="hidden" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['labelKey'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
" />
			<?php endif; ?>
...
unset($_smarty_tpl_vars);
 ?>
				...
				<?php else: ?>					<input type="text" name="newRowId[<?php echo ((is_array($_tmp=$this->_tpl_vars['column']->getId())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
]" class="textField" <?php if ($this->_tpl_vars['column']->getFlag('tabIndex')): ?>tabindex="<?php echo $this->_tpl_vars['column']->getFlag('tabIndex'); ?>
"<?php endif; ?> value="<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
" />
				<?php endif; ?>
			<?php elseif ($this->_tpl_vars['column']->getFlag('sourceType') == @LISTBUILDER_SOURCE_TYPE_SELECT): ?>
				<select name="newRowId[<?php echo ((is_array($_tmp=$this->_tpl_vars['column']->getId())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
]" class="selectMenu">
										<option value="<?php echo ((is_array($_tmp=$this->_tpl_vars['labelKey'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
